...
namespace Task1
{
   ...
   //     public Dictionary<Port, HangUpDelegate> ListenerHangUpFromTerminalToPort { get; set; }
   //     public void AddListenerHangUpFromTerminalToPort(Port port, HangUpDelegate listener)
   //     {
   //         if (listener == null) return;
   //         if (ListenerHangUpFromTerminalToPort.ContainsKey(port))
   //         {
   //             ListenerHangUpFromTerminalToPort[port] += listener;
   //         }
   //         else
   //             ListenerHangUpFromTerminalToPort[port] = listener;
   //     }
